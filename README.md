...
4. [Máquinas Virtuales y Scripts de Aprovisionamiento](#4-máquinas-virtuales-y-scripts-de-aprovisionamiento)
   - 4.1. [Balanceador de Carga](#41-balanceador-de-carga)
   - 4.2. [Servidor Web 1](#42-servidor-web-1)
   - 4.3. [Servidor Web 2](#43-servidor-web-2)
   - 4.4. [Servidor NFS](#44-servidor-nfs)
   - 4.5. [Proxy de Base de Datos](#45-proxy-de-base-de-datos)
   - 4.6. [Servidor de Datos 1](#46-servidor-de-datos-1)
   - 4.7. [Servidor de Datos 2](#47-servidor-de-datos-2)
...
[Ver video de demostración](https://drive.google.com/file/d/1WEOrJ2Cb0ox7-GAp7eYNu-jcAdxOHMFq/view?usp=drive_link)
